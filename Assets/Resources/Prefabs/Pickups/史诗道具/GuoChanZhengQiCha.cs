...
public class GuoChanZhengQiCha : Pickup 
{
    // 捡起获得buff的道具模板
	...
	override public void applyName(){
		...
		//起名
		if(name=="")name = " 国产蒸汽镲 "; //上面类名英文，和文件名一致，这个写中文给玩家看
		if(commit =="")commit = "学校食堂的箅子总是离奇消失，你们有什么头绪吗？";//道具小作文，中文
	}
    ...
    override public Hero.status item(){
        ...
        return new Hero.status(0,0,0,0,0,0,0,0,15,0,0);
    }
