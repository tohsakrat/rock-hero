...
public class HeJinKaZuDi : Pickup 
{
    // 捡起获得buff的道具模板
	...
	override public void applyName(){
		...
		//起名
		if(name=="")name = " 合金卡祖笛 "; //上面类名英文，和文件名一致，这个写中文给玩家看
		if(commit =="")commit = "主唱上台总是喜欢把这玩意偷偷揣在兜里。";//道具小作文，中文
	}
    ...
    override public Hero.status item(){
        ...
        return new Hero.status(0,0,0,0,0,0,10,0,0,0,0);
    }
