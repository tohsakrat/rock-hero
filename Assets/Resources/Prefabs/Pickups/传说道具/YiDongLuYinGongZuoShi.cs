...
public class YiDongLuYinGongZuoShi : Pickup 
{
    // 捡起获得buff的道具模板
	...
	override public void applyName(){
		...
		//起名
		if(name=="")name = " 移动录音工作室 "; //上面类名英文，和文件名一致，这个写中文给玩家看
		if(commit =="")commit = "手上的乐器拿稳了，前面路上石头比较多！";//道具小作文，中文
	}
    ...
    override public Hero.status item(){
        ...
        return new Hero.status(0,0,0,0,10,0,0,0,0,0,0);
    }
