...
public class HongLingJin : Pickup 
{
    // 捡起获得buff的道具模板
	...
	override public void applyName(){
		...
		//起名
		if(name=="")name = " 红领巾 "; //上面类名英文，和文件名一致，这个写中文给玩家看
		if(commit =="")commit = "风骚的走位，精简的装备，自信的表情，饱满的步伐，还有那鲜艳的红领巾。";//道具小作文，中文
	}
    ...
    override public Hero.status item(){
        ...
        return new Hero.status(0,0,0,0,0,0,30,0,0,0,0);
    }
