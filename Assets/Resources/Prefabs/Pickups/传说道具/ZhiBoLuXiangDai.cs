...
public class ZhiBoLuXiangDai : Pickup 
{
    // 捡起获得buff的道具模板
	...
	override public void applyName(){
		...
		//起名
		if(name=="")name = " 直播录像带 "; //上面类名英文，和文件名一致，这个写中文给玩家看
		if(commit =="")commit = "我早跟你说过那是一场直播。";//道具小作文，中文
	}
    ...
    override public Hero.status item(){
        ...
        return new Hero.status(0,0,0,0,0,0,0,5,0,0,0);
    }
